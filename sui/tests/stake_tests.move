#[test_only]
module nakama_amm::emergency_tests {
    use iota::test_scenario::{Scenario, next_tx, ctx, return_shared, end, take_from_sender, return_to_sender};
    use iota::test_scenario;
    use nakama_amm::stake_config;
    use nakama_amm::stake_config::GlobalConfig;
    use nakama_amm::stake;
    use iota::coin;
    use nakama_amm::stake_entries;
    use iota::clock::Clock;
    use iota::clock;
    use nakama_amm::stake::StakePool;
    use iota::coin::Coin;
